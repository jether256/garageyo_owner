...
class _AddPackageState extends State<AddPackage> {
  ...
  save() async {
    ...
    var response=await http.post(Uri.parse('https://bodayo.000webhostapp.com/api/owner/wash/addPack.php'),

        body:{"price":_priceC1.text,
          "shopName":'$bizname',
          "ownerName":'$name',
    ...
    if(response.statusCode==200){
      ...
      showDialog(
        ...
        builder:(context)=> AlertDialog(
          ...
          content:const Text('Package Saved..') ,
          actions:<Widget> [
            ElevatedButton(
              style: ButtonStyle(
      ...
      showDialog(
        ...
        builder:(context)=> AlertDialog(
          title:const Text('Message'),
          content:const Text('Package failed to save.') ,
          actions:<Widget> [
            ElevatedButton(
              style: ButtonStyle(
                backgroundColor:MaterialStateProperty.all(Colors.lightBlue),

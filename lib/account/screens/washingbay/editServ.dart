...
class EditService extends StatefulWidget {
  ...
  EditService({ required this.Price, required this.com, required this.Col, required this.serve, required this.carType, required this.proi});
...
class _EditServiceState extends State<EditService> {
  ...
  getProducts() async{
    ...
    setState(() {
      _service.text=widget.serve;
      _type.text=widget.carType;
      _priceO.text=widget.com;
      _priceC.text=widget.Price;
      _col.text=widget.Col;
  ...
  save() async {
    ...
    var response=await http.post(Uri.parse('https://bodayo.000webhostapp.com/api/owner/wash/addServe.php'),
    ...
    if(response.statusCode==200){
      ...
      showDialog(
        ...
        builder:(context)=> AlertDialog(
          title:const Text('Message'),
          content:const Text('Service failed to edit.') ,
          actions:<Widget> [
            ElevatedButton(
              style: ButtonStyle(
                backgroundColor:MaterialStateProperty.all(Colors.lightBlue),
  ...
  Widget build(BuildContext context) {
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return ListTile(
                          ...
                          leading: CircleAvatar(
                            backgroundImage: NetworkImage(
                              'https://bodayo.000webhostapp.com/admin/ajax/serve/${sir[index]['pic']}',
                            ),
                          ),
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edit Services ',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
      ),
      drawer: CustomD(),
      body: Form(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        child: const Text(' Washing Bay Services/Edit'),
                      ),
                    ),

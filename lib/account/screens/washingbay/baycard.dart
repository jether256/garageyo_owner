...
import 'editServ.dart';

class BayCard extends StatefulWidget {
  const BayCard({Key? key}) : super(key: key);

  @override
  _BayCardState createState() => _BayCardState();
}

class _BayCardState extends State<BayCard> {
  ...
  Future showAll() async {
    var response=await http.post(Uri.parse('https://bodayo.000webhostapp.com/api/owner/wash/getWash.php'),
        body:{'user_id':'$userID'});
                    ...
                    return DataRow(
                      cells: <DataCell>[
                        ...
                        DataCell(
                            ...
                            {
                            Navigator.push(context,MaterialPageRoute(builder: (context)=>EditService(
                            Price:'${e['price']}', com:'${e['compared']}',Col:'${e['collection']}',serve:'${e['service']}',
...
Future<void> ushould(s) async {
  var response=await http.post(Uri.parse('https://bodayo.000webhostapp.com/api/owner/wash/delwash.php'),

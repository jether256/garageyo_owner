...
import 'package:garageyo_owner/account/screens/washingbay/washL.dart';
...
class AddWash extends StatefulWidget {
  static const  String id='addwash';

  @override
  _AddWashState createState() => _AddWashState();
}
...
class _AddWashState extends State<AddWash> {
  ...
  save() async {
    ...
    var response=await http.post(Uri.parse('https://bodayo.000webhostapp.com/api/owner/wash/addService.php'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Services ',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
      ),
      drawer: CustomD(),
      body: Form(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        child: const Text(' Washing Bay Services/Add'),
                      ),
                    ),

...
import 'package:garageyo_owner/account/screens/washingbay/editPack.dart';
...
class _PackCardState extends State<PackCard> {
  ...
  Future showAll() async {
    var response=await http.post(Uri.parse('https://bodayo.000webhostapp.com/api/owner/wash/getPack.php'),
        body:{'user_id':'$userID'});
                    ...
                    return DataRow(
                      cells: <DataCell>[
                        ...
                        DataCell(
                            ...
                            {
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>EditPack(
                                  Price:'${e['price']}', com:'${e['compared']}',Col:'${e['collection']}',pack:'${e['pack']}',

...
class EditGara extends StatefulWidget {
  final String Price;
  final String com;
  final String Col;
  final String sa;
  ...
  EditGara({ required this.Price, required this.com, required this.Col, required this.sa, required this.carType, required this.proi});


  @override
  _EditGaraState createState() => _EditGaraState();
}

class _EditGaraState extends State<EditGara> {
  ...
  save() async {
    ...
    var response=await http.post(Uri.parse('https://bodayo.000webhostapp.com/api/owner/garage/editServe.php'),
                      ...
                      itemBuilder:(context,index){
                        ...
                        return ListTile(
                          ...
                          onTap: (){
                            ...
                            setState(() {
                              _package.text=sir[index]['service'];
                            });
                            Navigator.pop(context);

                          },
                          title: Text(sir[index]['service'],style:const TextStyle(fontSize:15,color: Colors.black),),
